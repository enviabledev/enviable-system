...
const ROLES: { name: string; description: string; permissions: string[] }[] = [
  {
    ...
    permissions: [
      ...
      'movement.read', 'sparepart.read', 'assembly.read', 'customer.read', 'pricelist.read',
      'salesorder.read', 'payment.confirm', 'costdata.view', 'report.stocks', 'report.revenue',
      'report.customers', 'approval.read', 'toggle.read', 'user.read', 'role.read', 'document.read',
    ],
  },
  {
    ...
    permissions: [
      ...
      'unit.read', 'movement.read', 'sparepart.read', 'assembly.read', 'customer.read',
      'pricelist.read', 'salesorder.read', 'payment.confirm', 'costdata.view', 'report.stocks',
      'report.revenue', 'report.customers', 'approval.read', 'approval.manage', 'toggle.read',
  ...
  },
  {
    ...
    permissions: [
      ...
      'sparepart.read', 'assembly.read', 'customer.read', 'pricelist.read', 'pricelist.manage',
      'salesorder.read', 'payment.confirm', 'delivery.manage', 'return.manage', 'costdata.view',
      'report.stocks', 'report.revenue', 'report.customers', 'conflict.resolve', 'approval.read',
      'toggle.read', 'user.read', 'role.read', 'document.read', 'document.manage',
    ],
  },
  {
    ...
    permissions: [
      'po.read', 'pi.read', 'shipment.read', 'unit.read', 'customer.read', 'salesorder.read',
      'report.stocks', 'document.read', 'document.manage',
    ],
  },
  {
    ...
    permissions: [
      ...
      'unit.read', 'movement.read', 'sparepart.read', 'costdata.view', 'document.read', 'document.manage',
    ],
  },
  {
    ...
    permissions: [
      ...
      'movement.read', 'sparepart.read', 'sparepart.manage', 'assembly.read', 'assembly.perform',
      'salesorder.read', 'delivery.manage', 'return.manage', 'costdata.view', 'report.stocks',
      'conflict.resolve', 'document.read',
    ],
  },
  {
    name: 'Assembly Floor Supervisor',
    description: 'Performs assembly jobs',
    permissions: ['unit.read', 'assembly.read', 'assembly.perform', 'sparepart.read'],
  },
  {
    name: 'Head of Sales',
    ...
    permissions: [
      ...
      'delivery.manage', 'return.manage', 'unit.read', 'costdata.view', 'report.revenue',
  ...
  },
  {
    ...
    permissions: [
      ...
      'return.manage', 'unit.read', 'costdata.view', 'report.revenue', 'report.customers',
      'document.read',
    ],
  },
  {
    ...
    permissions: [
      ...
      'payment.record', 'unit.read', 'document.read',
    ],
  },
  {
    name: 'Stock Auditor',
    ...
    permissions: [
      'unit.read', 'movement.read', 'sparepart.read', 'report.stocks', 'document.read',
    ],
  },
  {
    name: 'Quality Assurance',
    description: 'Inspects units; can adjust status for damage/repair',
    permissions: ['unit.read', 'unit.adjust', 'movement.read', 'assembly.read', 'document.read'],
  },
  {
    ...
    permissions: [
      ...
      'movement.read', 'salesorder.read', 'po.read', 'document.read',
    ],
  },
  {
    name: 'IT Admin',
